...
*** DONE Add in tags to ArticleDetailView using get_queryset.
    ...
    - CLOSING NOTE [2014-05-28 Wed 22:28]
*** IN-PROGRESS Add pagination to all List views and views that return lists of objects.
...
*** TODO Create tag cloud for tags
**** Install django-tag-tools and freeze pip installation to requirements/requirements_dev.py
**** Update jetpackjoust/settings/common.py to make django-tag-tools explicit.
**** Use generic tagged_object_list view to implement tag cloud
