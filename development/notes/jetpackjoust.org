...
** Create custom template tag to get dictionary access in tempates:
*** Create directory called "templatetags" in articles app directory
*** Add __init__ and file to contain extra tags.
*** Add following function to file
    @register.filter
