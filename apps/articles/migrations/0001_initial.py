...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_taggedarticle', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='articles_taggedarticle_items',
              to=orm['taggit.Tag'])),
            ('content_object',
             self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['articles.Article'])),
        ))
        ...
        db.create_table('articles_coverimage', (
            ...
            ('article',
             ...
             (to=orm['articles.Article'], unique=True)),
            ('source', self.gf('django.db.models.fields.files.ImageField')
             (max_length=100)),
        ...
        db.create_table('articles_image', (
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='article', to=orm['articles.Article'])),
            ('source', self.gf('django.db.models.fields.files.ImageField')
             (max_length=100)),
            ('caption', self.gf('django.db.models.fields.CharField')
             (max_length=200, null=True, blank=True)),
    ...
    models = {
        ...
        'articles.coverimage': {
            ...
            'article': ('django.db.models.fields.related.OneToOneField', [],
                        {'to': "orm['articles.Article']", 'unique': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [],
                   {'primary_key': 'True'}),
            'source': ('django.db.models.fields.files.ImageField', [],
                       {'max_length': '100'})
        },
        'articles.image': {
            'Meta': {'object_name': 'Image'},
            'article': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'article'", 'to':
                         "orm['articles.Article']"}),
            'caption': ('django.db.models.fields.CharField', [],
                        {'max_length':
                         '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [],
        ...
        'articles.taggedarticle': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [],
                    {'related_name':
                     "'articles_taggedarticle_items'", 'to':
                     "orm['taggit.Tag']"})
        },
        'taggit.tag': {
