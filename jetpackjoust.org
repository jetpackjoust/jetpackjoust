...
** IN-PROGRESS Complete tags views: index_tags, which shows each tag and links to
the show_tag view and show_tag, which shows list of articles containing tag.
